...
public class GeometryScalar {
    ...
    public static final GraphQLScalarType GEOMETRY =
        new GraphQLScalarType("Geometry", "A custom scalar that handles geometries",
            new Coercing() {
    ...
    private static Object serializeGeometry(Object dataFetcherResult) {
        if (isAGeometry(dataFetcherResult)) {
            ...
            try {
                return objectMapper
                    .readValue(objectMapper.writeValueAsString(geometry), HashMap.class);
            ...
            throw new CoercingSerializeException(
                "Unable to serialize " + dataFetcherResult + " as a geometry");
        }
    }
        ...
        if (input instanceof String) {
            ...
            try {
                ...
                throw new CoercingParseValueException(
                    "Unable to parse variable value " + input + " as a geometry");
            }
        }
        throw new CoercingParseValueException(
            "Unable to parse variable value " + input + " as a geometry");
    ...
    private static Object parseGeometryFromAstLiteral(Object input) {
        if (input instanceof StringValue) {
            ...
            try {
                ...
                throw new CoercingParseValueException(
                    "Unable to parse value " + input + " as a geometry");
            }
        }
